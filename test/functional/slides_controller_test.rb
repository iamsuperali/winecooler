...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { image: @slide.image, link: @slide.link, order: @slide.order, title: @slide.title }
    end
  ...
  test "should update slide" do
    put :update, id: @slide, slide: { image: @slide.image, link: @slide.link, order: @slide.order, title: @slide.title }
    assert_redirected_to slide_path(assigns(:slide))
  end
